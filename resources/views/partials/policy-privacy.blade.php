...
<p>
    ...
    и меры по обеспечению безопасности персональных данных, предпринимаемые Общество
    с ограниченной ответственностью Архитектурно-проектное бюро «ИД» (ООО АПБ «ИД»)
    (далее — Оператор).
</p>
<p>
...
<p>
    ...
    Анализ посещаемости сайта, улучшение его работы, повышение удобства использования
    и обеспечение корректного функционирования сайта.
</p>
<p>
    <strong>Персональные данные.</strong>
    IP-адрес, файлы cookie, сведения о браузере, сведения об операционной системе,
    сведения об устройстве, сведения о действиях пользователя на сайте, сведения
    о посещенных страницах, дата и время посещения, источник перехода на сайт.
</p>
<p>
    <strong>Правовые основания.</strong>
    Федеральный закон от 27.07.2006 № 152-ФЗ «О персональных данных» и иные нормативные
    правовые акты Российской Федерации, учредительные документы оператора.
</p>
<p>
...
<p>
    ...
    персональных данных, направив Оператору уведомление посредством электронной почты
...
<p>
    ...
    данных обязан уведомить уполномоченный орган по защите прав субъектов персональных данных
    о своем намерении осуществлять трансграничную передачу персональных данных (такое
...
<p>
    ...
    по адресу
    <a href="{{ route('privacy-policy') }}">https://idarchitects.ru/privacy</a>.
</p>
